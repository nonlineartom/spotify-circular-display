...
"$PYTHON_BIN" -m compileall -q server.py vinyl_library.py collection_routes.py display.py gpio_buttons.py wled_sync.py scripts tests
...
"$PYTHON_BIN" scripts/check_inline_js.py templates/index.html templates/join.html templates/connect.html templates/owner.html
node --check static/explore.js
node --check static/collection-editor.js
node --check static/touch-keyboard.js
node --check static/owner.js
node --check static/vendor/qrcode-generator-1.4.4.js
